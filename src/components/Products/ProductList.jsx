                            ...
                            return (
                                <Col xs={24} sm={12} md={direction == 'column' ? 24 : 8} lg={direction == 'column' ? 24 : 6} key={index}>
                                    ...
                                    >
                                        ...
                                        <h5>
                                            <del className="card-text lead fw-bold" style={{ color: '#666', fontWeight: '15px' }}>{convertTocurrency(product?.attributes?.oldPrice)}</del> <br />
                                        </h5>
                                        <h5 className='my-3'>
                                            <p className="card-text lead fw-bold">{convertTocurrency(product?.attributes?.price)}</p>
                                        </h5>
